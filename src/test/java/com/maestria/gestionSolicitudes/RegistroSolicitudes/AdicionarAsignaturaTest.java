...
@SpringBootTest
public class AdicionarAsignaturaTest {
    ...
    @Test
    void registrarSolicitudAdicionAsignaturaSinFirma() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAdicionAsignaturaTutorNoAsignado() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAdicionAsignaturaTipoSolicitudIncorrecto() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAdicionAsignaturaTutorNoDisponible() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAdicionAsignaturaCamposIncompletos() {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAdicionAsignaturaErrorRegistrarHistorial() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
