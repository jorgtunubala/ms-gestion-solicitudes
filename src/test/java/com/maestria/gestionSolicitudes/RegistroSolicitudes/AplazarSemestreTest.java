...
public class AplazarSemestreTest {
    ...
    @Test
    void registrarSolicitudAplazarSemestreSinFirma() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAplazarSemestreTutorNoAsignado() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAplazarSemestreTipoSolicitudIncorrecto() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAplazarSemestreTutorNoDisponible() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAplazarSemestreCamposIncompletos() {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarSolicitudAplazarSemestreErrorRegistrarHistorial() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
