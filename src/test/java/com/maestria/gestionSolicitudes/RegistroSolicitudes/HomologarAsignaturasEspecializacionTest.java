...
@SpringBootTest
public class HomologarAsignaturasEspecializacionTest {
    ...
    @Test
    void registrarHomologarAsignaturasEspecializacionConExito() throws Exception {
        // Given
    ...
    @Test
    void registrarHomologarAsignaturasEspecializacionSinFirma() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarHomologarAsignaturasEspecializacionTutorNoAsignado() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarHomologarAsignaturasEspecializacionTipoSolicitudIncorrecto() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarHomologarAsignaturasEspecializacionTutorNoDisponible() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarHomologarAsignaturasEspecializacionCamposIncompletos() {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
    ...
    @Test
    void registrarHomologarAsignaturasEspecializacionErrorRegistrarHistorial() throws Exception {
        // Given
        SolicitudRequestDto solicitudDto = crearSolicitudDto(1);
